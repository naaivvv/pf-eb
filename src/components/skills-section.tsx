...
const skillDomains = [
  ...
  },
  {
    ...
    icon: Bot,
    color: "var(--secondary)",
    skills: ["LLM API Integration", "RAG Systems", "AI Agent Architectures", "Prompt Engineering", "Langchain"],
  ...
  },
  {
    ...
    icon: Workflow,
    color: "var(--accent)",
    skills: ["N8n Automation", "Shell Scripting", "CI/CD Pipelines", "IoT Integration", "Task Orchestration"],
    gridClass: "md:col-span-1",
  },
  {
    ...
    icon: Globe,
    color: "var(--secondary)",
    skills: ["React.js", "Next.js", "Node.js", "Laravel/PHP", "Tailwind CSS", "Shopify"],
    gridClass: "md:col-span-1",
  },
  {
    title: "Data & Backend",
    icon: Database,
    color: "var(--primary)",
    skills: ["Python", "SQL", "Git/GitHub", "Linux", "Docker", "Virtual Environments"],
    gridClass: "md:col-span-1",
  },
  {
