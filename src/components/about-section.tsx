    ...
    <section id="about" className="relative w-full min-h-screen overflow-hidden bg-transparent" ref={ref}>
      <div className="relative z-10 max-w-6xl mx-auto section-padding pointer-events-none">
        ...
        <div className="grid lg:grid-cols-5 gap-8">
          {/* Summary Card */}
          <div
            className={`lg:col-span-3 glass rounded-2xl p-8 transition-all duration-700 delay-100 ${
              isInView ? "animate-fade-up opacity-100" : "opacity-0 translate-y-6"
            }`}
          >
            ...
            <p className="text-base leading-relaxed mb-8" style={{ color: "var(--muted-foreground)" }}>
              ...
              TUP-Visayas while actively taking on freelance R&D consulting work — architecting thesis systems 
