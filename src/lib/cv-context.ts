...
## TECHNICAL ARSENAL
*   **Software Engineering & Web**: Python, TypeScript, C++, React, Next.js, Node.js, Vite, Tailwind CSS, shadcn/ui.
*   **AI, ML & Computer Vision**: Deep expertise in training and deploying Computer Vision models (YOLO architectures, LPRNet, PaddleOCR). Skilled in integrating LLMs and Agentic workflows via OpenRouter API and RAG architectures. Proficient in TensorFlow Lite and OpenCV.
...
*   **Infrastructure & Cloud**: Docker containerization, Supabase, Firebase, RESTful API design.
